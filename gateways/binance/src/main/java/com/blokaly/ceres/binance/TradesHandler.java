...
public class TradesHandler {
  ...
  private static final String TRADE_TIME_COL = "tradeId";
  ...
  private void buildPoint(long time, String symbol, double price, double size, long tradeTime, boolean isBuyerMaker, PointBuilderFactory.BatchedPointBuilder builder) {
