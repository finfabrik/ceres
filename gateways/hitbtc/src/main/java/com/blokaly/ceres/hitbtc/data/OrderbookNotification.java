...
public class OrderbookNotification extends AbstractEvent {
    ...
    public OrderbookNotification(final String symbol, final long sequence, MarketDataIncrementalTagged update, MarketDataIncrementalTagged deletion) {
    ...
    public static OrderbookNotification parse(String symbol, long sequence, JsonArray asksArray, JsonArray bidsArray ){
        ...
        return new OrderbookNotification(symbol, sequence, update, deletion);
